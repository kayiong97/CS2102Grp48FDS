...
<body>
<h1>View All Customer Orders</h1>

<?php
//Hiding Errors 
error_reporting(E_ERROR | E_PARSE);
$db = pg_connect("host=localhost port=5432 dbname=cs2102fds48 user=postgres password=postgres");
/*$result = pg_query($db,"SELECT o.orderId, o.totalordercost, o.orderdatatime, o.deliverylocaion, o.deliveryfee    
						FROM customers cust
						JOIN completes c
...
/*Order table and customer table cannot join order table*/
echo "<table>";
