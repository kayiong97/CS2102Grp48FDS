    ...
    <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <!-- lOGO TEXT HERE -->
                <a href="index.html" class="navbar-brand">PORT'S<span>.</span> Food Delivery Service</a>
            </div>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-nav-first">
                    ...
                    <li><a href="#Restaurant" class="smoothScroll">Restaurant</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <a href="viewAccountProfile.php" class="section-btn" id="navViewAccountProfile" 
                    <?php 
                    ...
                    <a href="login.php" class="section-btn" id="navLogin" 
                    <?php 
                    if( isset( $_SESSION["username"] ) ){ 
                    echo 'style="display:none;"'; 
                    }else{ 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image1.jpg" class="image-popup" title="American Breakfast">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <!-- MENU THUMB -->
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image2.jpg" class="image-popup" title="Self-made Salad">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <!-- MENU THUMB -->
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image3.jpg" class="image-popup" title="Chinese Noodle">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <!-- MENU THUMB -->
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image4.jpg" class="image-popup" title="Rice Soup">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <!-- MENU THUMB -->
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image5.jpg" class="image-popup" title="Project title">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <!-- MENU THUMB -->
                                <div class="menu-thumb">
                                    <a href="../assets/images/menu-image6.jpg" class="image-popup" title="Project title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4">
                                ...
                                <div class="wow fadeInUp copyright-text" data-wow-delay="0.8s">
                                    <p>
                                        <br>Copyright &copy; 2018 <br>Your Company Name
