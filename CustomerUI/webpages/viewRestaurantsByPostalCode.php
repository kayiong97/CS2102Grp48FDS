  ...
  opacity: 0.7;
        ...
        <!-- Restaurants -->
            <section id="about" data-stellar-background-ratio="0.5">
                ...
                <div class="container">
                    <div class="row">
                        <h2><u>>> Restaurants <?php echo "(Delivery to S".$_SESSION[ "postalCodeEntered"].")"; ?></u></h2> 
    ...
    if(isset($_POST['btnViewFoodBasedOnRestaurant'])){
        ...
        echo "<script>location.href = '/cs2102grp48fds/CustomerUI/webpages/viewFoodByRestaurant.php'</script>";
                                    ...
                                    if( isset( $_SESSION[ "restaurantsBasedOnPostalCode"] ))
                                    {
                                        $listOfRestaurantIdToBeRetrievedArray = $_SESSION["restaurantsBasedOnPostalCode"];
